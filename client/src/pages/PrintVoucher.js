...
const PrintVoucher = ({
    ...
    useEffect(() => {
        const loadVouchers = async () => {
            ...
            if (response.data) {
                setNextVoucher(response.data.find(voucher => !voucher.counting));
            }
            context.dispatch({
                type: "SET_VOUCHERS",
    ...
    console.log("next voucher?", nextVoucher)
    ...
    const handleClose = () => {
        ...
        setTimeout(async () => {
            ...
            vouchers = vouchers.filter(voucher => voucher._id !== nextVoucher._id);
